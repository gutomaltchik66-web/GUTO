...
5. **Diário — Citação + Perguntas (10 min)** — Para fechar, os alunos releem no Diário a citação de Êxodo 18:19 e respondem 1) a pergunta ligada ao trecho (por que ouvir perguntas difíceis de uma banca pode fortalecer a ideia) e 2) a pergunta fixa *"O que eu aprendi na aula de hoje?"*. Agradecer o convidado (se houver) e anunciar a Aula 17 como encerramento do semestre. Texto completo em `ferramentas/diario-do-empreendedor.md`.
