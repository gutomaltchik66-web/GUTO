# Aula 16 — 14/12 — Banca de investidores (convidado ou simulação)
...
1. **Abertura com a frase do dia (5 min)** — Ler em voz alta: Provérbios 15:22: *"Onde não há conselho, os projetos se frustram; mas com muitos conselheiros se confirmam."* Explicar que essa é uma segunda chance de apresentar, sem pressão de nota — foco em receber perguntas difíceis e pensar rápido.
...
5. **Diário — Citação + "O que eu aprendi hoje?" (10 min)** — Para fechar, os alunos releem no Diário a citação de Provérbios 15:22 e respondem a pergunta padrão *"O que eu aprendi na aula de hoje?"*, além de atualizar "Minha ideia hoje". Agradecer o convidado (se houver) e anunciar a Aula 17 como encerramento do semestre. Texto completo em `ferramentas/diario-do-empreendedor.md`.
