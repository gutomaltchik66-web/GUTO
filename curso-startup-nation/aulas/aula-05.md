...
4. **Conexão com o Brasil e com a escola (10 min)** — Em grupos pequenos: listar programas (públicos ou da escola) que ajudam jovens a empreender — feiras de ciência, editais, incubadoras, a própria eletiva Start Up Nation.
5. **Diário — Citação + "O que eu aprendi hoje?" (10 min)** — Para fechar, os alunos leem no Diário a citação de Pirkei Avot 3:2 (Rabi Chanina: *"Reza pelo bem-estar do governo..."*) e respondem a pergunta padrão *"O que eu aprendi na aula de hoje?"*, além de atualizar "Minha ideia hoje". Texto completo em `ferramentas/diario-do-empreendedor.md`.
