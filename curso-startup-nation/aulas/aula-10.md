...
1. **Abertura com a frase do dia (5 min)** — Ler em voz alta: Pirkei Avot 1:17 (Shimon ben Gamliel): *"Não o estudo é o principal, mas a ação."* Provocar: hoje é o dia de agir, não só planejar.
...
7. **Diário — Citação + "O que eu aprendi hoje?" (10 min)** — Para fechar, os alunos releem no Diário a citação de Pirkei Avot 1:17 e respondem a pergunta padrão *"O que eu aprendi na aula de hoje?"*, além de atualizar "Minha ideia hoje". Texto completo em `ferramentas/diario-do-empreendedor.md`.
