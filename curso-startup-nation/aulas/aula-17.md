...
- *Desta aula:* Mural das Ideias (Aula 1) · Baú de Aprendizados (Aula 4) · demais materiais produzidos ao longo do semestre, se possível expostos na sala
...
2. **Linha do tempo do semestre (10 min)** — Em roda, o professor retoma rapidamente cada bloco: Fundamentos (chutzpah, erro, Estado/Exército), Ecossistema (estudos de caso, tikun olam), Meu Projeto (mapa de empatia, canvas, protótipo, pitch), Avaliação e Fechamento.
