# Aula 17 — 21/12 — Encerramento do semestre
...
**Materiais:** cópias de `ferramentas/rotina-entrada-saida.md`, Mural das Ideias (Aula 1), Baú de Aprendizados (Aula 4), todos os materiais produzidos ao longo do semestre, se possível expostos na sala.

## Roteiro (90 min)

1. **Ficha de Entrada (5 min)** — Pergunta do dia: *"Em uma frase, o que você sabia sobre empreendedorismo/Israel no primeiro dia de aula?"*
...
6. **Ficha de Saída (5 min)** — Roda de agradecimento: cada aluno diz uma palavra que resume o semestre, além de preencher a ficha normalmente.
7. **Encerramento formal (5 min)** — Fechar a eletiva agradecendo a turma.

## Produto da aula
Carta final de reflexão — pode compor a nota de participação/processo do semestre, junto com a nota do Pitch Day (Aula 13) — + Ficha de Saída.
