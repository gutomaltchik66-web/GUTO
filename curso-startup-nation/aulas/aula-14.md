...
**Materiais:** cópias de `ferramentas/rotina-entrada-saida.md`, fichas de rubrica preenchidas na Aula 13, protótipos, mesas/espaço comum (pátio ou corredor, se possível combinar com a coordenação).

## Roteiro (90 min)

1. **Ficha de Entrada (5 min)** — Pergunta do dia: *"O que você espera ouvir hoje sobre o seu pitch?"*
2. **Devolutiva individual (20 min)** — Devolver a ficha de rubrica de cada aluno/dupla, com nota e comentário. Dar 5 min para leitura silenciosa e reação.
...
6. **Ficha de Saída (5 min)** — além do padrão, registrar: *"O que mais gostei de ver no projeto de um colega foi..."*

## Produto da aula
Banquinha montada + participação ativa na feira + Ficha de Saída.
