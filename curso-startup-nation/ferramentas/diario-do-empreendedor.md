...
── ENTRADA (preencher sozinho, em silêncio, assim que sentar) ──

1. Em uma frase, o que ficou da aula passada?


2. Pergunta do dia: [ver plano de cada aula]
...
── SAÍDA (preencher antes de guardar o material, ao final da aula) ──

O que eu produzi/fiz hoje:
...
1. **Entrada (5 min, sempre no início)** — assim que senta, o aluno já sabe: abrir o Diário na página do dia e responder sozinho, em silêncio, enquanto o professor faz a chamada. A pergunta 1 é sempre igual (exceto na Aula 1, que vira uma pergunta de apresentação pessoal, sem aula anterior para retomar). A pergunta 2 muda a cada aula e está indicada no roteiro de cada plano.
2. **Minha ideia hoje (1 frase, o fio contínuo do semestre)** — a mesma linha, em toda página, do início ao fim do semestre. Nas primeiras aulas pode ser só um palpite vago ("ainda não sei", "algo relacionado a..."); a partir da Aula 7 (lançamento do desafio) começa a ganhar forma; nas Aulas 8–13 acompanha a evolução direta do projeto. É o único item que compara diretamente a página de hoje com a de semanas atrás — vale reler o caderno inteiro na Aula 17.
3. **Saída (5 min, sempre no final)** — antes de guardar o material, o aluno fecha a página do dia. Funciona como registro de presença ativa (quem não preencheu, não "participou" de fato) e como termômetro rápido para o professor — ler as dúvidas antes da próxima aula ajuda a decidir o que retomar na Entrada seguinte.

## Por que funciona com turma agitada

- Rotina idêntica em toda aula = menos tempo de instrução, menos brecha para dispersão.
- Tarefa individual e silenciosa nos dois extremos da aula (entrada e saída) cria uma "borda" de foco antes e depois das atividades em grupo, que são mais barulhentas por natureza.
