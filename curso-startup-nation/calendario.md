...
- **Diário do Empreendedor em toda aula.** Todas fecham (10 min, individual e silenciosa) com uma citação de fonte judaica diferente, a pergunta padrão "O que eu aprendi na aula de hoje?" e a linha "Minha ideia hoje", no mesmo caderno contínuo — ver `ferramentas/diario-do-empreendedor.md`. É a tarefa que se repete nas 17 aulas, tanto para dar rotina fixa (a turma sempre sabe o que fazer no fechamento) quanto para registrar a evolução da própria ideia semana a semana.
