...
- **Diário do Empreendedor em toda aula.** Todas começam (10 min, individual e silenciosa) com um trecho de fonte judaica diferente, duas Questões do Dia e a linha "Minha ideia hoje", no mesmo caderno contínuo — ver `ferramentas/diario-do-empreendedor.md`. É a tarefa que se repete nas 17 aulas, tanto para dar rotina fixa (a turma sempre sabe o que fazer ao entrar) quanto para registrar a evolução da própria ideia semana a semana.
